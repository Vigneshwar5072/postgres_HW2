...
-- Started on 2021-09-25 19:56:55
...
--
-- TOC entry 3002 (class 0 OID 16552)
-- Dependencies: 205
-- Data for Name: rdata; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.rdata (id, a, b, moment, x) FROM stdin;
1	my_na	mine	2020-01-01	30.33
2	your	your1	2020-01-01	80.23
3	my_n	min	2020-03-01	33.33
4	my_nl	minkl	2020-03-01	13.33
\.
...
--
-- TOC entry 2866 (class 2606 OID 16566)
...
--
-- TOC entry 2868 (class 2606 OID 16568)
...
--
-- TOC entry 2870 (class 2606 OID 16564)
...
-- Completed on 2021-09-25 19:56:55
